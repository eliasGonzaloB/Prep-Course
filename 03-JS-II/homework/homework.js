...
function tablaDelSeis(){
  ...
  for (let i = 0; i < 11; i++) {
        arrayTablaDel6.push(6 * i) /*El método push() añade uno o más elementos al final de un array
...
function doWhile(numero) {
  ...
  //La sentencia (hacer mientras) crea un búcle que ejecuta una sentencia especificada, 
