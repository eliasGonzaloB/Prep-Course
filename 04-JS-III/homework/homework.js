...
function agregarItemAlFinalDelArray(array, elemento) {
  ...
  array.push(elemento); //.push() agrega elemento al final del array.
  return array;
...
function agregarItemAlComienzoDelArray(array, elemento) {
  ...
  array.unshift(elemento); //.unshift() agrega al cominezo del array.
  return array;
...
function promedioResultadosTest(resultadosTest) {
  ...
  //Promedio = suma todos los elementos y luego los divide por el total de los elementos.
...
function empiezaConNueve(n) {
  ...
  //El método .toString() devuelve una cadena que representa al objeto.
